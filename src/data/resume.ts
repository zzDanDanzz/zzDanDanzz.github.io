  ...
  work: [
    {
      ...
      highlights: [
        ...
        "Web GIS Platform: Architected the front-end for a spatial data platform, engineering dynamic dataset filtering, vector and raster tile integration, and a Zustand-powered client-side PDF export engine.",
        "Offline-First PWA: Architected an offline-first PWA using IndexedDB to cache gigabytes of vector data, allowing nationwide surveyors to seamlessly sync geographic edits in zero-connectivity environments.",
        ...
        "Web CAD-to-GIS Pipeline: Engineered a browser-based DXF-to-GeoJSON pipeline utilizing a WASM port of GDAL, featuring a custom Deck.gl georeferencing tool to align floor plans with land parcels.",
